...
* `calc_flowstats_old`, `predict_indices_old` and `join_he_old`, prevuious versions 
...
The `hetoolkit` package was developed by APEM LTD on behalf on the Environment Agency. Version 1.0.0 was released in May 2021. For further information please contact Mike Dunbar at the Environment Agency.

## Change history

Version | Date    | Details
--------|---------|---------------
1.0.0   | 05-2021 | New release
2.0.0   | TBC     | Added new function impute_flows/
                    Major updates to calc_flowstats, predict_indices and join_he

## Examples

Further information on the functions contained within the package, including examples, can be found in the `HE Toolkit - Vingette` at https://apem-ltd.github.io/hetoolkit_updated/.

## Reporting Bugs

Please aid future development of the package by reporting bugs via the Issues page on github.
