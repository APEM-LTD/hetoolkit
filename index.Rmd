...
The `hetoolkit` package comprises a collection of 22 functions, developed by APEM LTD on behalf of the Environment Agency, to assemble, process, visualise and model hydro-ecological data. The full set of functions are listed under the Reference tab above. Note that they include deprecated versions of three functions that are retained for back-compatibility. 
