...
Yes, the import_wq() function allows you to download data for determinands of interest from the EA's Water Quality Explorer (https://environment.data.gov.uk/water-quality-beta). 
