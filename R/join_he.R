...
#' @param flow_stats Data frame (output[[1]] from 'calc_flowstats' function), containing the processed flow statistics. Must contain the following columns: flow_site_id, water_year and season.
