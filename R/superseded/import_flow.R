...
#'            col_order = c(1,2,3)
#'
#' # If no data to be imported from local files, then 'dir', 'skip_num' and 'col_order' do not need to be defined.
...
# usethis::usepackage("dplyr", "tidyr", "tibble", "sjmisc")


import_flow <- function(sites, inputs, start_date = "1985-01-01", end_date = Sys.Date(), dir = NULL, skip_num = NULL, col_order = NULL){
  ...
  # check if any of the defined stations are present in the station list
