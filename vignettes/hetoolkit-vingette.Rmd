...
env_data_final$BOULDERS_COBBLES[is.na(env_data_final$BOULDERS_COBBLES)] <- 0
...
# run predictions
predict_data <- predict_indices(env_data = env_data_final, all_indices = TRUE)
...
predict_data_final <- predict_data[ , (names(predict_data) %in% keeps)]
