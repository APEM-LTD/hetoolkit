...
The code below demonstrates the how to summarise whether these columns contain NAs, and how to replace NAs as required. Note, this code will only run if using data in the "EDE" file format.
