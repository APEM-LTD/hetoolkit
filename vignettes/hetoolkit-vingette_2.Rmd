...
```{r hevplot2, message=FALSE, warning=FALSE, include=FALSE}
...
# model_1 has higher RMSE than model_full, so keep Q95z slope
cv_1[1]
...
# model_2 has lower RMSE than model_full, so drop Q95zLS1
cv_2[1]
...
# model_3 has lower RMSE than model_2, so drop Q10z
cv_3[1]
