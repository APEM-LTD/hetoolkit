...
#saveRDS(cs2_cv_gam1, "vignettes/data/cs2_cv_gam1.RDS")
#saveRDS(cs2_cv_gam2, "vignettes/data/cs2_cv_gam2.RDS")

#cs2_cv_gam1 <- readRDS("vignettes/data/cs2_cv_gam1.RDS")
#cs2_cv_gam2 <- readRDS("vignettes/data/cs2_cv_gam2.RDS")
...
viz.gam <- mgcViz::getViz(cs2_gam2)
print(plot(viz.gam, allTerms = TRUE), pages = 1)
summary(cs2_gam2)
