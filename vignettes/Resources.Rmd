...
Training videos based on based on two workshops are available to view online. The first workshop covers:

 * Data import 
 * Infilling and characterising flows 
 * Running RICT to calculate OE ratios 
 * Joining datasets 
 * Data visualisation.
 
The second workshop is more focused on statistical analysis of hydroecological data, and covers:

 * Understanding the analysis of spaitio-temporal data using linear mixed-effects models
 * Characterising flow histories
 * Assessing the suitability of the data for developing models
 * Building, calibrating and validating statistical regression models
 * Applying these models to make predictions.
