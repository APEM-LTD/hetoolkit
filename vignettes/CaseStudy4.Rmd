---
title: "Illustration of the climwin approach to detecting ecologically significant flow periods"
author: "Environment Agency (National Hydroecology Team, WR E&B) & APEM"
...
params:
  date: !r Sys.Date
subtitle: HE Toolkit Case Study
editor_options:
...
opts_chunk$set(echo = TRUE, message=FALSE, warning=FALSE, tidy.opts = list(width.cutoff = 100), tidy = TRUE, fig.path = 'Plots/') 
